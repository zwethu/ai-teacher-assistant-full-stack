...
function navLinkClass(
  ...
  const layout = showLabels
    ? 'gap-3 px-3 py-2.5'
    : 'justify-center gap-0 p-2.5 w-full'
  ...
  return (
    <>
      ...
      >
        ...
        <nav className={`flex-1 pb-4 space-y-2 overflow-y-auto overflow-x-hidden ${collapsed ? 'px-2' : 'px-5'}`}>
        ...
        <div className={`border-t border-slate-100 flex-shrink-0 ${collapsed ? 'px-2 py-5' : 'px-5 py-5'}`}>
