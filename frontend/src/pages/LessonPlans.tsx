    ...
    <div className="pb-8">
      ...
      <div className="mb-4">
        ...
        <p className="text-sm text-slate-500 mt-1">
          Generate a lesson plan from the batch’s course materials, web search, and any attachments.
        </p>
      </div>
      ...
      <div className="mt-6 min-w-0">
        ...
        {listLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-10 text-center rounded-xl border border-slate-100 bg-white">
            ...
            <p className="text-sm text-slate-500">No lesson plans yet for this batch.</p>
          </div>
        ) : (
