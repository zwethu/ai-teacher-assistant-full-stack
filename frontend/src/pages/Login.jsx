        ...
        <div className="w-full lg:w-[480px] xl:w-[520px] h-full flex flex-col justify-center p-10 lg:p-12 login-card overflow-y-auto no-scrollbar">
          ...
          <div className="space-y-6">
            <button
              ...
              disabled={signingIn}
              className="group flex items-center justify-center gap-4 w-full bg-emerald-600 hover:bg-emerald-700 disabled:opacity-70 disabled:cursor-not-allowed text-white font-bold py-5 px-6 rounded-2xl transition shadow-xl"
            >
              {signingIn ? (
                <>
                  <span
          ...
          <footer className="mt-auto pt-8 border-t border-slate-200 text-xs text-slate-500 flex flex-col sm:flex-row justify-between gap-2">
            <span>&copy; 2025 Pyin Nyar AI</span>
