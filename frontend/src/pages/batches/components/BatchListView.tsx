  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
        ...
        <Button type="button" onClick={openCreateDialog} className="h-11 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-violet-500 sm:flex-shrink-0 sm:min-w-[180px]">
